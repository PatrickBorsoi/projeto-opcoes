...
path_pasta_opcoes = os.path.expanduser("C:/Users/Patrick/Desktop/workspace/pipeline_opcoes/data/22-10-2024_arquivo todas opções.xlsx")
...
df_total['Strike'] = df_total['Strike']
